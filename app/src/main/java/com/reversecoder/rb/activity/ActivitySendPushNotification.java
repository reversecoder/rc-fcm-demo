...
public class ActivitySendPushNotification extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private void loadRegisteredDevices() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AllUrls.URL_FETCH_DEVICES,
    ...
    private void sendMultiplePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AllUrls.URL_SEND_MULTIPLE_PUSH,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
    ...
    private void sendSinglePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AllUrls.URL_SEND_SINGLE_PUSH,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
